...
export class UIService implements OnDestroy {
  ...
  constructor(
    ...
    const mockDevicesData = [
      {
        ...
        settings: [{ key: 'brightness', value: 75 }],
        isOnline: true,
        connected: true,
        setupRequired: false,
      },
      {
        ...
        settings: [{ key: 'temperature', value: 22 }],
        isOnline: true,
        connected: true,
        setupRequired: false,
      },
      ...
      },
      {
        ...
        driverId: 13,
        zoneId: 3,
        capabilities: ['streaming', 'motion-detection', 'night-vision'],
        settings: [{ key: 'resolution', value: '1080p' }],
        isOnline: true,
        connected: true,
        setupRequired: false,
      },
      {
        ...
        settings: [{ key: 'autoLock', value: true }],
        isOnline: false,
        connected: false,
        setupRequired: false,
      },
      {
        ...
        settings: [{ key: 'fanSpeed', value: 'medium' }],
        isOnline: true,
        connected: true,
        setupRequired: false,
      },
    ...
    setTimeout(() => (this.devices = new DevicesModel(mockDevicesData)), 5000);
  }
